...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7b42458, const void *arg_0xb7b425f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7af38c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb799d840), 
int (*key_eq_fn)(void *arg_0xb799dc88, void *arg_0xb799de00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb786c9b8, int arg_0xb786cb10);
static double RandomUniform(void );
...
typedef TMilli sendAckC$MsgTimer$precision_tag;
...
static void sendAckC$MsgTimer$fired(void );
...
message_t * msg);
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void sendAckC$MsgTimer$startPeriodic(uint32_t dt);
#line 78
static void sendAckC$MsgTimer$stop(void );
# 32 "sendAckC.nc"
...
static inline void sendAckC$MsgTimer$fired(void );
...
#line 174
static void sendAckC$Read$readDone(error_t result, uint16_t data);
# 53 "/opt/tinyos-main-2.1.2/tos/chips/atm128/timer/HplAtm128TimerCtrl8.nc"
...
#line 55
  __nesc_result = ecombine(__nesc_result, /*sendAckAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$read());
#line 55
...
#line 139
    {
      ...
      sim_log_debug(166U, "radio_rec", "Received packet at time %s\n", sim_time_string());
      sim_log_debug(167U, "radio_pack", " Payload length %hhu \n", sendAckC$Packet$payloadLength(buf));
      sim_log_debug(168U, "radio_pack", ">>>Pack \n");
      sim_log_debug_clear(169U, "radio_pack", "\t\t Payload Received\n");
      ...
      sendAckC$rec_id[sim_node()] = __nesc_ntoh_uint16(mess->counter.nxdata);
...
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void sendAckC$MsgTimer$startPeriodic(uint32_t dt){
#line 64
...
{
  if (err == SUCCESS) {
      sim_log_debug(158U, "radio", "Radio on!\n");
      if (TOS_NODE_ID == 1) {
          sim_log_debug(159U, "timer", "Message timer stop\n");
          sendAckC$MsgTimer$startPeriodic(1000);
        }
    }
  else {
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb7308ca8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb7308ca8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb7308ca8, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb77c8650){
#line 75
  switch (arg_0xb77c8650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb77c8650);
#line 75
      break;
#line 75
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void sendAckC$MsgTimer$stop(void ){
#line 78
...
#line 67
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb7305730, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb7305730, addr, msg, len);
#line 80
...
#line 41
{
  ...
  __nesc_hton_uint16(mess->value.nxdata, 0);
  ...
  if (sendAckC$PacketAcknowledgements$requestAck(&sendAckC$packet[sim_node()]) == SUCCESS) 
    {
      sim_log_debug(149U, "radio_ack", "Ack requested\n");
    }
  else {
      sim_log_error(150U, "radio_ack", "Ack request not supported\n");
    }
  ...
  if (sendAckC$AMSend$send(2, &sendAckC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
      ...
      sim_log_debug_clear(154U, "radio_pack", "\t\t counter: %hhu \n", __nesc_ntoh_uint16(mess->counter.nxdata));
      sim_log_debug_clear(155U, "radio_pack", "\t\t type: %hhu \n ", __nesc_ntoh_uint8(mess->type.nxdata));
...
#line 103
{
  sim_log_debug(160U, "timer", "Message timer fired at %s.\n", sim_time_string());
  sendAckC$sendReq();
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb737d3a8){
#line 83
  switch (arg_0xb737d3a8) {
#line 83
    case 0U:
#line 83
      sendAckC$MsgTimer$fired();
#line 83
      break;
#line 83
    case 1U:
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb737d3a8);
#line 83
      break;
#line 83
    }
...
#line 110
{
  ...
  if (sendAckC$PacketAcknowledgements$wasAcked(buf) == TRUE && TOS_NODE_ID == 1) {
      sim_log_debug(164U, "radio_ack", "Acknowledged packet\n");
      sendAckC$MsgTimer$stop();
      sim_log_debug(165U, "timer", "Message timer stop\n");
    }
}
...
#line 177
  ...
  sim_log_debug(174U, "value", "value read done %f\n", value);

  __nesc_hton_uint16(mess->value.nxdata, value);
  __nesc_hton_uint8(mess->type.nxdata, 2);
  __nesc_hton_uint16(mess->counter.nxdata, sendAckC$rec_id[sim_node()]);

  sim_log_debug(175U, "radio_pack", "Preparing the response... \n");

  if (sendAckC$PacketAcknowledgements$requestAck(&sendAckC$packet[sim_node()]) == SUCCESS) 
    {
      sim_log_debug(176U, "radio_ack", "Ack requested\n");
    }
  else {
      sim_log_error(177U, "radio_ack", "Ack request not supported\n");
    }

  if (sendAckC$AMSend$send(1, &sendAckC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
      sim_log_debug(178U, "radio_send", "Packet passed to lower layer successfully!\n");
      sim_log_debug(179U, "radio_pack", ">>>Pack\n \t Payload length %hhu \n", sendAckC$Packet$payloadLength(&sendAckC$packet[sim_node()]));
      sim_log_debug_clear(180U, "radio_pack", "\t Payload Sent\n");
      sim_log_debug_clear(181U, "radio_pack", "\t\t counter: %hhu \n", __nesc_ntoh_uint16(mess->counter.nxdata));
      sim_log_debug_clear(182U, "radio_pack", "\t\t type: %hhu \n ", __nesc_ntoh_uint8(mess->type.nxdata));
      sim_log_debug_clear(183U, "radio_pack", "\t\t value: %hhu \n", __nesc_ntoh_uint16(mess->value.nxdata));
    }
}
