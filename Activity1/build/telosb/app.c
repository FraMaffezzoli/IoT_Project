...
extern int memcmp(const void *arg_0xb7c07690, const void *arg_0xb7c07828, size_t arg_0xb7c079c0);
extern void *memcpy(void *arg_0xb7c07e68, const void *arg_0xb7c05030, size_t arg_0xb7c051c8);

extern void *memset(void *arg_0xb7c05e90, int arg_0xb7c04010, size_t arg_0xb7c041a8);
#line 65
extern void *memset(void *arg_0xb7bf8d30, int arg_0xb7bf8e88, size_t arg_0xb7bf7030);
...
struct _reent {
  ...
  void (*__cleanup)(struct _reent *arg_0xb7bd53b8);
  ...
  void (**_sig_func)(int arg_0xb7bd2a70);
...
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0xb760e0a0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = CC2420ActiveMessageP__AMSend__send(arg_0xb760e0a0, addr, msg, len);
#line 80
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Receive__receive(am_id_t arg_0xb6e559d0, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb6e559d0) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = CC2420ActiveMessageP__Receive__default__receive(arg_0xb6e559d0, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 71 "/opt/tinyos-main-2.1.2/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__readDone(uint8_t arg_0xb736d010, uint8_t * data, uint8_t length, error_t error){
#line 71
  switch (arg_0xb736d010) {
#line 71
    case CC2420_TXFIFO:
#line 71
...
#line 71
    default:
#line 71
      CC2420SpiP__Fifo__default__readDone(arg_0xb736d010, data, length, error);
#line 71
      break;
#line 71
    }
...
# 91 "/opt/tinyos-main-2.1.2/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__writeDone(uint8_t arg_0xb736d010, uint8_t * data, uint8_t length, error_t error){
#line 91
  switch (arg_0xb736d010) {
#line 91
    case CC2420_TXFIFO:
...
#line 91
    default:
#line 91
      CC2420SpiP__Fifo__default__writeDone(arg_0xb736d010, data, length, error);
#line 91
      break;
#line 91
    }
...
#line 100
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void CC2420ActiveMessageP__AMSend__sendDone(am_id_t arg_0xb6e55010, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0xb6e55010, msg, error);
#line 110
}
#line 110
# 120 "/opt/tinyos-main-2.1.2/tos/interfaces/Resource.nc"
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0xb760f6a8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb760f6a8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0xb760f6a8, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static void SchedulerBasicP__TaskBasic__runTask(uint8_t arg_0xb7917b40){
#line 75
  switch (arg_0xb7917b40) {
#line 75
...
#line 75
    default:
#line 75
      SchedulerBasicP__TaskBasic__default__runTask(arg_0xb7917b40);
#line 75
      break;
#line 75
    }
